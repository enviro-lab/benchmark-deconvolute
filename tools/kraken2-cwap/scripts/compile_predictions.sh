...
for plate in $plates; do
    ...
    tsv_dir=kraken2-cwap/tsvs/${plate}
    agg_dir=kraken2-cwap/agg
    ...
    cp $cwap_dir/*/*_k2-majorCovid_bracken.out "${tsv_dir}"

    # aggregate results
    echo "Aggregating results"
    python kraken2-cwap/scripts/aggregate_predictions.py --tsv "${tsv_dir}" -o "${agg_dir}/$plate.tsv"
