...
set -eu
#SBATCH --mem=98gb           	# Maximum physical memory to use for job
...
snakemake --config markers=ucsc dataset=${plate}  --cores 32 --resources mem_gb=2000 --rerun-incomplete  # --unlock 
